...
void setup() {
  ...
  */
  ...
  QUKEYS(
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 1), Key_LeftGui),      // A/cmd
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 2), Key_LeftAlt),      // S/alt 
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 3), Key_LeftControl),  // D/ctrl
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 4), Key_LeftShift),    // F/shift
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(0, 7), Key_LeftBracket), // Left Control/Left Bracket
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 7), Key_LeftCurlyBracket), // Left Gui/Left Curly Bracket
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(3, 7), Key_LeftParen),    // Left Shift/Parentheses
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(3, 8), Key_RightParen),  // Right Shift/Parentheses
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 8), Key_RightCurlyBracket), // Right Alt/Right Curly Bracket
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(0, 8), Key_RightBracket),// Right Control/Right Bracket
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 11), Key_RightShift),    //J/shift
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 12), Key_RightControl),// K/ctrl
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 13), Key_RightAlt),    // L/alt
    kaleidoscope::plugin::Qukey(PRIMARY, KeyAddr(2, 14), Key_RightGui)     // ;/gui
  )
  Qukeys.activate();
