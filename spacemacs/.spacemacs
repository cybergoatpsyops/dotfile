...
(defun dotspacemacs/user-config ()
  ...
  (run-at-time nil (current-time) 300 'recentf-save-list)
...
(custom-set-faces
 ...
 '(italic ((t (:slant italic :weight thin :height 180 :width normal :foundry "JB" :family "JetBrainsMonoNL Nerd Font")))))
)
