...
(defun dotspacemacs/user-config ()
  ...
  (setq deft-extensions '("org" "md" "text" "wiki"))
...
(use-package cape
  ...
  ;; Hide whitespace dots
  (setq org-hide-leading-stars nil)
  (setq org-superstar-leading-bullet ?\s)

  ;; Calendar/Diary integration for agenda
  (setq org-agenda-include-diary t)

  ;; Use eww to open links
  (setq browse-url-browser-function 'eww-browse-url)

  ;; todo dependencies strategy
  ...
  (setq org-todo-keywords
        '((sequence "TODO" "DOING" "BLOCKED" "REVIEW" "NEXT" "|" "CANCELED" "DONE" "ARCHIVED")))

  ;; set new todo color/appearances
...
(custom-set-faces
 ...
 '(italic ((t (:slant italic :weight thin :height 120 :width normal :foundry "JB" :family "JetBrainsMonoNL Nerd Font")))))
)
